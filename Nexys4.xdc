...
set_property PACKAGE_PIN U9 [get_ports {cmd[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cmd[0]}]
##Bank = 34, Pin name = IO_25_34,							Sch name = SW1
set_property PACKAGE_PIN U8 [get_ports {cmd[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cmd[1]}]
##Bank = 34, Pin name = IO_L23P_T3_34,						Sch name = SW2
set_property PACKAGE_PIN R7 [get_ports {cmd[2]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cmd[2]}]
##Bank = 34, Pin name = IO_L19P_T3_34,						Sch name = SW3
set_property PACKAGE_PIN R6 [get_ports {cmd[3]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cmd[3]}]
##Bank = 34, Pin name = IO_L19N_T3_VREF_34,					Sch name = SW4
set_property PACKAGE_PIN R5 [get_ports {cmd[4]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cmd[4]}]
##Bank = 34, Pin name = IO_L20P_T3_34,						Sch name = SW5
set_property PACKAGE_PIN V7 [get_ports {cmd[5]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {cmd[5]}]
...
#set_property PACKAGE_PIN T1 [get_ports {led12}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {led12}]
##Bank = 34, Pin name = IO_L11P_T1_SRCC_34,					Sch name = SW13
#set_property PACKAGE_PIN R3 [get_ports {led13}]					
	#set_property IOSTANDARD LVCMOS33 [get_ports {led13}]
##Bank = 34, Pin name = IO_L14N_T2_SRCC_34,					Sch name = SW14
set_property PACKAGE_PIN P3 [get_ports {pause}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {pause}]
##Bank = 34, Pin name = IO_L14P_T2_SRCC_34,					Sch name = SW15
set_property PACKAGE_PIN P4 [get_ports {play}]					
...
set_property PACKAGE_PIN F15 [get_ports haut]						
	set_property IOSTANDARD LVCMOS33 [get_ports haut]
##Bank = CONFIG, Pin name = IO_L15N_T2_DQS_DOUT_CSO_B_14,	Sch name = BTNL
set_property PACKAGE_PIN T16 [get_ports gauche]						
	set_property IOSTANDARD LVCMOS33 [get_ports gauche]
##Bank = 14, Pin name = IO_25_14,							Sch name = BTNR
set_property PACKAGE_PIN R10 [get_ports droite]						
	set_property IOSTANDARD LVCMOS33 [get_ports droite]
##Bank = 14, Pin name = IO_L21P_T3_DQS_14,					Sch name = BTND
set_property PACKAGE_PIN V10 [get_ports bas]						
	set_property IOSTANDARD LVCMOS33 [get_ports bas]
